...
//console.log("before Mutator methods: " + loot);
loot.sort();
console.log("Sorted loot: ", loot.sort());
console.log("Reversed loot: ", loot.reverse());
console.log("Copied loot: ", loot.copyWithin(0, 3, 5));
console.log("Final loot: ", loot.fill("unknown", 2, 5));
